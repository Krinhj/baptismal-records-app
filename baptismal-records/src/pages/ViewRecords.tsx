  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setSuccessToast(`Record for ${deleteModal.record.childName} deleted successfully`);
        setTimeout(() => {
              ...
              <div className="p-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900">{deleteModal.record.childName}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-700">Baptism Date:</span>
                    <span className="text-gray-900">{formatDate(deleteModal.record.baptismDate)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-700">Priest:</span>
                    <span className="text-gray-900">{deleteModal.record.priestName}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-700">Parents:</span>
                    <span className="text-gray-900">{formatParents(deleteModal.record.fatherName, deleteModal.record.motherName)}</span>
                  </div>
                </div>
              </div>
